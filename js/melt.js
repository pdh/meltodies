...
(function() {
  'use strict';
  var AddSongModalCtrl, DeleteSongModalCtrl, MeltController, _setColumnWidth, song_template, started, transition_search_input, youtube_iframe_template;
  ...
  MeltController = function($scope, $http, $modal, $location, localStorageService, $analytics) {
    ...
    return $scope.confirm_delete = function() {
